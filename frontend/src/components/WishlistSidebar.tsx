...
const WishlistSidebar: React.FC<WishlistSidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-[80vw] max-w-xs sm:w-full sm:max-w-md bg-white dark:bg-gray-900 shadow-xl">
        <div className="flex h-full flex-col">
          ...
          <div className="flex items-center justify-between border-b border-gray-700 px-6 py-4">
            ...
            <button
              onClick={onClose}
              className="dark:text-gray-400 text-gray-900 hover:text-white transition-colors"
            >
              <X className="h-6 w-6" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto px-6 py-4">
            {items.length === 0 ? (
              <div className="flex flex-col items-center justify-center h-full text-center">
                ...
                <p className="dark:text-gray-400 text-gray-900 text-lg mb-2">Your wishlist is empty</p>
                <p className="dark:text-gray-500 text-gray-900 text-sm">Save items you love for later</p>
              </div>
            ) : (
