...
const Footer = () => {
  return (
    <>
    <div className="relative w-full bottom-0 z-40 bg-white border-gray-200 dark:bg-black dark:border-zinc-500 py-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex max-md:flex-col">
              <input
                ...
                className="flex-1 bg-gray-200 dark:bg-gray-800 placeholder:text-black dark:placeholder:text-white border border-gray-700 px-4 py-3 rounded-l-lg max-md:rounded-t-lg max-md:rounded-b-none focus:outline-none focus:border-teal-500"
              />
