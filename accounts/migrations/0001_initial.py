    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar_color', models.CharField(blank=True, help_text="Hex color code for the user's avatar background, e.g., #RRGGBB.", max_length=7, null=True)),
                ...
                ('current_refresh_token', models.CharField(blank=True, max_length=255, null=True)),
